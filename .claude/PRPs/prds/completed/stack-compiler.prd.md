...
|---|-------|-------------|--------|----------|---------|------|--------|----|
| 0 | PRD reconciliation | Harness PRD: Phase 5 superseded by this PRD, Phase 6 → complete, skill registry, vocabulary, new Phase 7 (co- hook on PRD writes). Cap-PRD: cross-link, answer open question 3 | complete | - | - | - | - | - |
...
| 3 | Selection | Interactive confirmation writing `chosen` via `stack.py`; staleness check on catalog hash | complete | with 4 | 2 | [selection plan](/home/felix/projects/howtobuildsoftware2026/.claude/PRPs/plans/completed/stack-compiler-selection.plan.md) | [implementation report](/home/felix/.prp/howtobuildsoftware2026-35325a96/reports/stack-compiler-selection-report.md) | [#28](https://github.com/neurawork-git/howtobuildsoftware2026/pull/28) |
| 4 | `st-` gate | `st-post-tooluse` on PRD + plan writes: allowlist / applicable-capability / license checks, precheck + debounced LLM report, warn\|block | complete | with 3 | 2 | [st- gate plan](/home/felix/projects/howtobuildsoftware2026/.claude/PRPs/plans/completed/stack-compiler-st-gate.plan.md) | [implementation report](/home/felix/.prp/howtobuildsoftware2026-35325a96/reports/stack-compiler-st-gate-report.md) | [#31](https://github.com/neurawork-git/howtobuildsoftware2026/pull/31) |
| 5 | Wire & document | `install.py` / `recon.py` / payload / tests, the `stack-compiler` install skill (no `/st-init`), `/st-scope`, `/st-rank`, `/st-select`, `/st-validate`, self-host, docs + CLAUDE.md | complete | - | 3, 4 | [wire & document plan](/home/felix/projects/howtobuildsoftware2026/.claude/PRPs/plans/completed/stack-compiler-wire-document.plan.md) | [implementation report](/home/felix/projects/howtobuildsoftware2026/.claude/PRPs/reports/stack-compiler-wire-document-report.md) | [#43](https://github.com/neurawork-git/howtobuildsoftware2026/pull/43) |
