...
| 4 | Wire & document | `/co-capabilities` command, hook nudge when the layer is absent, docs/CLAUDE.md (SessionStart bootstrap superseded by the shipped catalog seed) | complete | - | 2, 3 | [wire & document plan](../../plans/completed/compliance-capabilities-wire-document.plan.md) | [report](/home/felix/.prp/howtobuildsoftware2026-35325a96/reports/compliance-capabilities-wire-document-report.md) | [#26](https://github.com/neurawork-git/howtobuildsoftware2026/pull/26) |
