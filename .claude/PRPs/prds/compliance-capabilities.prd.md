...
| 3 | Capability validator | Extend `validate.py`: documents declare capabilities, gate on mandatory coverage. Stays here (capability level); the component-allowlist gate is `stack-compiler` Phase 4 | in-progress | with 2 | 1 | [validator plan](/home/felix/projects/howtobuildsoftware2026/.claude/PRPs/plans/compliance-capability-validator.plan.md) | [report](/home/felix/.prp/howtobuildsoftware2026-35325a96/reports/compliance-capability-validator-report.md) | [#24](https://github.com/neurawork-git/howtobuildsoftware2026/pull/24) |
