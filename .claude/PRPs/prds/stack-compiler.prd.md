...
| 4 | `st-` gate | `st-post-tooluse` on PRD + plan writes: allowlist / applicable-capability / license checks, precheck + debounced LLM report, warn\|block | complete | with 3 | 2 | [st- gate plan](/home/felix/projects/howtobuildsoftware2026/.claude/PRPs/plans/stack-compiler-st-gate.plan.md) | [implementation report](/home/felix/.prp/howtobuildsoftware2026-35325a96/reports/stack-compiler-st-gate-report.md) | [#31](https://github.com/neurawork-git/howtobuildsoftware2026/pull/31) |
| 5 | Wire & document | `install.py` / `recon.py` / payload / tests, the `stack-compiler` install skill (no `/st-init`), `/st-scope`, `/st-rank`, `/st-select`, `/st-validate`, self-host, docs + CLAUDE.md | complete | - | 3, 4 | [wire & document plan](/home/felix/projects/howtobuildsoftware2026/.claude/PRPs/plans/stack-compiler-wire-document.plan.md) | [implementation report](/home/felix/projects/howtobuildsoftware2026/.claude/PRPs/reports/stack-compiler-wire-document-report.md) | [#43](https://github.com/neurawork-git/howtobuildsoftware2026/pull/43) |
