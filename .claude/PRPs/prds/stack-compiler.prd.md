...
| 1 | Scope engine | Idea + requirements → applicable frameworks + per-capability applicability with reasons; mandatory-safety gate. Schema fields shipped 2026-08-13; `gaps()` still counts non-applicable capabilities as gaps and must learn to skip them here | in-progress | - | 0, cap-PRD 2 | [scope engine plan](/home/felix/projects/howtobuildsoftware2026/.claude/PRPs/plans/stack-compiler-scope-engine.plan.md) | - | - |
