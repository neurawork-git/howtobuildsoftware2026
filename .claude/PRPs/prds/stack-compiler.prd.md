...
| 4 | `st-` gate | `st-post-tooluse` on PRD + plan writes: allowlist / applicable-capability / license checks, precheck + debounced LLM report, warn\|block | in-progress | with 3 | 2 | [st- gate plan](/home/felix/projects/howtobuildsoftware2026/.claude/PRPs/plans/stack-compiler-st-gate.plan.md) | - | - |
