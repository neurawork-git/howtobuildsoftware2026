...
| 5 | Wire & document | `install.py` / `recon.py` / payload / tests, `/st-init`, `/st-scope`, `/st-select`, `/st-validate`, self-host, docs + CLAUDE.md | in-progress | - | 3, 4 | [wire & document plan](/home/felix/projects/howtobuildsoftware2026/.claude/PRPs/plans/stack-compiler-wire-document.plan.md) | - | - |
