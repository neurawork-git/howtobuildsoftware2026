...
then appends the result to ``daily/<date>.md``. Does NOT trigger compilation —
that is handled by the manual command and the SessionStart 6h gate.
...
capturing only what is worth preserving. Do NOT use any tools — return plain text.
...
**Key Exchanges:**
- important question/answer or discussion
...
**Action Items:**
- follow-up or TODO mentioned

Skip routine tool calls, file reads, trivial back-and-forth, and anything obvious.
